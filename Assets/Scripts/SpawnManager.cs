...
public class SpawnManager : MonoBehaviour {
    public GameObject smallGolam, Bat, Pung, Golam;
    ...
    {
        Count -= 1;
        Vector3 BarPos = Bar.rectTransform.position;
        BarPos.x = ((30 - (10 * (3 - Round)) - (10 - Count))/30.0f)*360;
        Bar.rectTransform.position = BarPos;
    }
